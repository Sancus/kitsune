...
GROUPED_FIREFOX_VERSIONS = (
    ((_lazy(u'Desktop:'), 'desktop'), (
        ...
        VersionMetadata(5, _lazy(u'Thunderbird 5'),
                        _lazy(u'Thunderbird 5'), 'tb5', 5.9999, False, False),
        VersionMetadata(7, _lazy(u'Thunderbird 7'),
                        _lazy(u'Thunderbird 7'), 'tb7', 7.9999, False, False),
        VersionMetadata(8, _lazy(u'Thunderbird 8'),
                        _lazy(u'Thunderbird 8'), 'tb8', 8.9999, False, False),
        VersionMetadata(9, _lazy(u'Thunderbird 9'),
                        _lazy(u'Thunderbird 9'), 'tb9', 9.9999, False, False),
        VersionMetadata(10, _lazy(u'Thunderbird 10'),
                        _lazy(u'Thunderbird 10'), 'tb10', 10.9999, False, False),
        VersionMetadata(11, _lazy(u'Thunderbird 11'),
                        _lazy(u'Thunderbird 11'), 'tb11', 11.9999, False, False),
        VersionMetadata(12, _lazy(u'Thunderbird 12'),
                        _lazy(u'Thunderbird 12'), 'tb12', 12.9999, False, False),
        VersionMetadata(13, _lazy(u'Thunderbird 13'),
                        _lazy(u'Thunderbird 13'), 'tb13', 13.9999, False, False),
        VersionMetadata(14, _lazy(u'Thunderbird 14'),
                        _lazy(u'Thunderbird 14'), 'tb14', 14.9999, False, False),
        VersionMetadata(15, _lazy(u'Thunderbird 15'),
                        _lazy(u'Thunderbird 15'), 'tb15', 15.9999, True, False),
        VersionMetadata(16, _lazy(u'Thunderbird 16'),
                        _lazy(u'Thunderbird 16'), 'tb16', 16.9999, True, False),
        VersionMetadata(17, _lazy(u'Thunderbird 17'),
                        _lazy(u'Thunderbird 17'), 'tb17', 17.9999, True, False),
        VersionMetadata(24, _lazy(u'Thunderbird 24'),
                        _lazy(u'Thunderbird 24'), 'tb24', 24.9999, True, True),
